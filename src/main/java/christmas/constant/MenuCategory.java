...
public enum MenuCategory {
    APPETIZER(Arrays.asList(Menu.MUSHROOM_SOUP.getMenuName(), Menu.TAPAS.getMenuName(), Menu.CAESAR_SALAD.getMenuName())),
    MAIN(Arrays.asList(Menu.T_BONE_STEAK.getMenuName(), Menu.BARBECUE_LIBS.getMenuName(), Menu.SEAFOOD_PASTA.getMenuName(),
